  ...
  <div class="main-content">
    ...
    <div class="card-group">
      ...
      <div class="card">
        ...
        <img src="./assets/img/{{$main->img}}" class="card-img-top" alt="...">
        <div class="card-body">
          <h2 class="card-title">{{$main->title}}</h2>
          <div class="card-text">{!! $main->nd_tt !!}</div>
          <a name="" id="" class="btn read-more"  href="tin-tuc/{{$main->id}}" role="button">Đọc tiếp...</a>
        </div>
      </div>
    ...
    <div class="main-sidebar">
      ...
      <a class="card  card-sidebar" href="tin-tuc/{{$item->id}}">
        <div class="row g-0">
          <div class="col-md-3">
            <img src="./assets/img/{{$item->img}}" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
